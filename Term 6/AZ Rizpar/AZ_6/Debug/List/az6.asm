...
; 0000 002B interrupt [8] void timer1_compa_isr(void) {
...
; .FSTART _timer1_compa_isr
	...
	IN   R30,SREG
	ST   -Y,R30
; 0000 002C     milisecond += 1;
	MOVW R30,R4
	ADIW R30,1
	MOVW R4,R30
; 0000 002D 
; 0000 002E 
; 0000 002F     if(hour == 24) {
	LDI  R30,LOW(24)
	LDI  R31,HIGH(24)
	CP   R30,R10
	CPC  R31,R11
	BRNE _0x3
; 0000 0030         lcd_gotoxy(3,1);
	LDI  R30,LOW(3)
	CALL SUBOPT_0x0
; 0000 0031         lcd_puts("  ");
	__POINTW2MN _0x4,0
...
; 0000 0046     }
; 0000 0047 
; 0000 0048     itoa(milisecond, str_ms);
_0x7:
	ST   -Y,R5
	ST   -Y,R4
	LDI  R26,LOW(_str_ms)
	...
	CALL _itoa
; 0000 0049     lcd_gotoxy(12,1);
	LDI  R30,LOW(12)
	CALL SUBOPT_0x0
; 0000 004A     lcd_puts(str_ms);
	LDI  R26,LOW(_str_ms)
	LDI  R27,HIGH(_str_ms)
	CALL _lcd_puts
; 0000 004B 
; 0000 004C     itoa(second, str_s);
	ST   -Y,R7
	ST   -Y,R6
	LDI  R26,LOW(_str_s)
	LDI  R27,HIGH(_str_s)
	CALL _itoa
; 0000 004D     lcd_gotoxy(9,1);
	LDI  R30,LOW(9)
	CALL SUBOPT_0x0
; 0000 004E     lcd_puts(str_s);
	LDI  R26,LOW(_str_s)
	LDI  R27,HIGH(_str_s)
	CALL _lcd_puts
; 0000 004F 
; 0000 0050     itoa(minute, str_m);
	ST   -Y,R9
	ST   -Y,R8
	LDI  R26,LOW(_str_m)
	LDI  R27,HIGH(_str_m)
...
; 0000 0051     lcd_gotoxy(6,1);
	LDI  R30,LOW(6)
	CALL SUBOPT_0x0
; 0000 0052     lcd_puts(str_m);
	LDI  R26,LOW(_str_m)
	LDI  R27,HIGH(_str_m)
	CALL _lcd_puts
; 0000 0053 
; 0000 0054     itoa(hour, str_h);
	ST   -Y,R11
	ST   -Y,R10
	LDI  R26,LOW(_str_h)
	LDI  R27,HIGH(_str_h)
	CALL _itoa
; 0000 0055     lcd_gotoxy(3,1);
	LDI  R30,LOW(3)
	CALL SUBOPT_0x0
; 0000 0056     lcd_puts(str_h);
	LDI  R26,LOW(_str_h)
	LDI  R27,HIGH(_str_h)
	CALL _lcd_puts
; 0000 0057 }
...
; 0000 0061 DDRA=(0<<DDA7) | (0<<DDA6) | (0<<DDA5) | (0<<DDA4) | (0<<DDA3) | (0<<DDA2) | (0<<DDA1) | (0<<DDA0);
	LDI  R30,LOW(0)
	OUT  0x1A,R30
...
; 0000 006D DDRC=(0<<DDC7) | (0<<DDC6) | (0<<DDC5) | (0<<DDC4) | (0<<DDC3) | (0<<DDC2) | (0<<DDC1) | (0<<DDC0);
	OUT  0x14,R30
...
; 0000 00CD     OCR1AH=0x0C;
	LDI  R30,LOW(12)
	OUT  0x2B,R30
; 0000 00CE     OCR1AL=0x35;
	LDI  R30,LOW(53)
	OUT  0x2A,R30
...
; 0000 00D7 // RS - PORTC Bit 0
; 0000 00D8 // RD - PORTC Bit 1
; 0000 00D9 // EN - PORTC Bit 2
; 0000 00DA // D4 - PORTC Bit 4
; 0000 00DB // D5 - PORTC Bit 5
; 0000 00DC // D6 - PORTC Bit 6
; 0000 00DD // D7 - PORTC Bit 7
...
; 0000 00E1     lcd_clear();
	CALL _lcd_clear
; 0000 00E2 
; 0000 00E3     lcd_gotoxy(3,0);
	LDI  R30,LOW(3)
	ST   -Y,R30
	LDI  R26,LOW(0)
	CALL _lcd_gotoxy
; 0000 00E4     lcd_puts("LCD CLOCK");
	__POINTW2MN _0x8,0
	CALL _lcd_puts
; 0000 00E5 
