...
_0x0:
	...
	.DB  0x73,0x6F,0x72,0x0,0x25,0x64,0x0,0x54
	.DB  0x65,0x6D,0x70,0x3A,0x0,0x43,0x0
_0x2020003:
	.DB  0x80,0xC0
...
; 0000 0092 // ADC Clock frequency: 250.000 kHz
; 0000 0093 // ADC Voltage Reference: AVCC pin
; 0000 0094 // ADC Auto Trigger Source: ADC Stopped
; 0000 0095 ADMUX=ADC_VREF_TYPE;
	LDI  R30,LOW(64)
	OUT  0x7,R30
; 0000 0096 ADCSRA=(1<<ADEN) | (0<<ADSC) | (0<<ADATE) | (0<<ADIF) | (0<<ADIE) | (1<<ADPS2) | (0<<ADPS1) | (1<<ADPS0);
	LDI  R30,LOW(133)
	OUT  0x6,R30
...
; 0000 00B0          lcd_clear();
	CALL _lcd_clear
; 0000 00B1 
; 0000 00B2          lcd_gotoxy(3,0);
	LDI  R30,LOW(3)
	ST   -Y,R30
	LDI  R26,LOW(0)
	CALL _lcd_gotoxy
; 0000 00B3          lcd_puts("LM35 Sensor");
	__POINTW2MN _0x9,0
	CALL _lcd_puts
; 0000 00B4 
; 0000 00B5          temp = read_adc(0);
	LDI  R26,LOW(0)
	RCALL _read_adc
	MOVW R4,R30
; 0000 00B6          temp = (int)(temp * 0.488);
	CALL __CWD1
	CALL __CDF1
	__GETD2N 0x3EF9DB23
	CALL __MULF12
	CALL __CFD1
	MOVW R4,R30
; 0000 00B7          sprintf(output, "%d", temp);
	LDI  R30,LOW(_output)
	...
	CALL _sprintf
	ADIW R28,8
; 0000 00B8          lcd_gotoxy(9,1);
	LDI  R30,LOW(9)
	CALL SUBOPT_0x0
; 0000 00B9          lcd_puts(output);
	LDI  R26,LOW(_output)
	LDI  R27,HIGH(_output)
	CALL _lcd_puts
; 0000 00BA 
; 0000 00BB          lcd_gotoxy(3,1);
	LDI  R30,LOW(3)
	CALL SUBOPT_0x0
; 0000 00BC          lcd_puts("Temp:");
	__POINTW2MN _0x9,12
	CALL _lcd_puts
; 0000 00BD          lcd_gotoxy(12,1);
	LDI  R30,LOW(12)
	CALL SUBOPT_0x0
; 0000 00BE          lcd_putchar(223);
	LDI  R26,LOW(223)
	CALL _lcd_putchar
; 0000 00BF          lcd_gotoxy(13,1);
	LDI  R30,LOW(13)
	CALL SUBOPT_0x0
; 0000 00C0          lcd_puts("C");
	__POINTW2MN _0x9,18
	CALL _lcd_puts
; 0000 00C1 
