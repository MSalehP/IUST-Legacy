...
; 0000 0085       itoa(a,str);
	...
	MOVW R26,R16
	CALL _itoa
; 0000 0086       lcd_puts(str);
	MOVW R26,R16
	RCALL _lcd_puts
; 0000 0087       lcd_putchar(' ');
	LDI  R26,LOW(32)
	RCALL _lcd_putchar
