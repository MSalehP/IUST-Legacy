...
_0x0:
	.DB  0x69,0x7A,0x69,0x7A,0x61,0x20,0x61,0x7A
	.DB  0x65,0x72,0x69,0x6C,0x61,0x0
_0x2000003:
	.DB  0x80,0xC0
...
; 0000 002A int i =0;
; 0000 002B int posx = 0;
; 0000 002C int posy = 0;
...
; 0000 0051 // Clock value: 31.250 kHz
; 0000 0052 // Mode: CTC top=OCR1A
...
; 0000 005C TCCR1A=(0<<COM1A1) | (0<<COM1A0) | (0<<COM1B1) | (0<<COM1B0) | (0<<WGM11) | (0<<WGM10);
	OUT  0x2F,R30
; 0000 005D TCCR1B=(0<<ICNC1) | (0<<ICES1) | (0<<WGM13) | (1<<WGM12) | (1<<CS12) | (0<<CS11) | (0<<CS10);
	LDI  R30,LOW(12)
	OUT  0x2E,R30
...
; 0000 0061 ICR1L=0x00;
	OUT  0x26,R30
; 0000 0062 OCR1AH=0x7A;
	LDI  R30,LOW(122)
	OUT  0x2B,R30
; 0000 0063 OCR1AL=0x12;
	LDI  R30,LOW(18)
	OUT  0x2A,R30
...
; 0000 0072 TIMSK=(0<<OCIE2) | (0<<TOIE2) | (0<<TICIE1) | (1<<OCIE1A) | (0<<OCIE1B) | (0<<TOIE1) | (0<<OCIE0) | (0<<TOIE0);
	LDI  R30,LOW(16)
	OUT  0x39,R30
; 0000 0073 
...
_0x3:
; 0000 00A5 {
; 0000 00A6 char* name = "iziza azerila";
; 0000 00A7 for( i=0; i < 13; i++)
	SBIW R28,2
	LDI  R30,LOW(_0x6)
	LDI  R31,HIGH(_0x6)
	ST   Y,R30
...
; 0000 00B3 posx += 16;
	__ADDWRN 18,19,16
; 0000 00B4 }
; 0000 00B5 lcd_gotoxy( posx, posy);
_0xD:
	ST   -Y,R18
	MOV  R26,R20
	RCALL _lcd_gotoxy
; 0000 00B6 lcd_putchar(name[i]);
	LD   R26,Y
	LDD  R27,Y+1
	ADD  R26,R16
	ADC  R27,R17
