...
_0x0:
	.DB  0x69,0x6E,0x20,0x74,0x68,0x65,0x20,0x6E
	.DB  0x61,0x6D,0x65,0x20,0x6F,0x66,0x20,0x67
	.DB  0x6F,0x64,0xA,0xD,0x0
_0x2020060:
	.DB  0x1
_0x2020000:
...
;	x -> Y+0
	...
	CPC  R5,R27
	BREQ _0x7
; 0000 0016 int first_digit = x % 10;
; 0000 0017 int second_digit = (x / 10) % 10;
; 0000 0018 int third_digit = (x / 100) % 10;
; 0000 0019 
; 0000 001A putchar(third_digit + '0');
	SBIW R28,6
;	x -> Y+6
;	first_digit -> Y+4
;	second_digit -> Y+2
;	third_digit -> Y+0
	...
	SUBI R26,-LOW(48)
	RCALL _putchar
; 0000 001B putchar(second_digit + '0');
	LDD  R26,Y+2
	SUBI R26,-LOW(48)
	RCALL _putchar
; 0000 001C putchar(first_digit + '0');
	LDD  R26,Y+4
	SUBI R26,-LOW(48)
	RCALL _putchar
; 0000 001D 
