...
_segpos:
	.DB  0x7D,0x0,0x7B,0x0,0x77,0x0,0x6F,0x0
	.DB  0x5F,0x0,0x3F,0x0
_tbl10_G100:
...
; 0000 004A PORTC = bcdequ(ch - '0');
	...
	RCALL _bcdequ
	OUT  0x15,R30
; 0000 004B PORTB = segpos[5 - pos]; // Change this line to display from right segment
	LDI  R30,LOW(5)
	LDI  R31,HIGH(5)
	SUB  R30,R6
	SBC  R31,R7
	LDI  R26,LOW(_segpos*2)
	LDI  R27,HIGH(_segpos*2)
	LSL  R30
	ROL  R31
	ADD  R30,R26
	ADC  R31,R27
...
; 0000 0055 DDRB=(1<<DDB7) | (1<<DDB6) | (1<<DDB5) | (1<<DDB4) | (1<<DDB3) | (1<<DDB2) | (1<<DDB1) | (1<<DDB0);
	LDI  R30,LOW(255)
	OUT  0x17,R30
...
; 0000 006A TIMSK=(0<<OCIE2) | (0<<TOIE2) | (0<<TICIE1) | (0<<OCIE1A) | (0<<OCIE1B) | (0<<TOIE1) | (0<<OCIE0) | (1<<TOIE0);
	...
	OUT  0x39,R30
; 0000 006B 
; 0000 006C // Global enable interrupts
; 0000 006D #asm("sei")
	SEI
; 0000 006E 
...
_0xE:
; 0000 007D {
; 0000 007E ch = getchar();
	RCALL _getchar
	MOV  R5,R30
; 0000 007F 
; 0000 0080 if (ch >= '0' && ch <= '9') {
	LDI  R30,LOW(48)
	CP   R5,R30
	BRLO _0x12
	LDI  R30,LOW(57)
