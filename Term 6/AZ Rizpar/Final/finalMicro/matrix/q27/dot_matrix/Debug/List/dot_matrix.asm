...
_image_code:
	.DB  0xFF,0x81,0xEE,0xEE,0xEE,0x81,0xFF,0x80
	.DB  0xBF,0xBF,0xBF,0xBF,0xFF,0xFF,0xBE,0x80
	.DB  0xBE,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF
...
; 0000 0049 DDRA=(1<<DDA7) | (1<<DDA6) | (1<<DDA5) | (1<<DDA4) | (1<<DDA3) | (1<<DDA2) | (1<<DDA1) | (1<<DDA0);
	LDI  R30,LOW(255)
	OUT  0x1A,R30
...
; 0000 004F DDRC=(1<<DDC7) | (1<<DDC6) | (1<<DDC5) | (1<<DDC4) | (1<<DDC3) | (1<<DDC2) | (1<<DDC1) | (1<<DDC0);
	LDI  R30,LOW(255)
	OUT  0x14,R30
...
; 0000 0055 DDRD=(1<<DDD7) | (1<<DDD6) | (1<<DDD5) | (1<<DDD4) | (1<<DDD3) | (1<<DDD2) | (1<<DDD1) | (1<<DDD0);
	LDI  R30,LOW(255)
	OUT  0x11,R30
...
_0x3:
; 0000 005A {
; 0000 005B unsigned int i, offset = 18;
; 0000 005C for (; offset < 18 + 35; offset++) {
	SBIW R28,4
	LDI  R30,LOW(18)
	ST   Y,R30
	LDI  R30,LOW(0)
...
_0x7:
	...
	SBIW R26,53
	BRSH _0x8
; 0000 005D int repeat = 0;
; 0000 005E for (; repeat < 5; repeat++) {
	SBIW R28,2
	LDI  R30,LOW(0)
	ST   Y,R30
	STD  Y+1,R30
...
_0xA:
	...
	SBIW R26,5
	BRGE _0xB
; 0000 005F unsigned long scan = 1;
; 0000 0060 PORTA = 0; //C9-C16
	SBIW R28,4
	LDI  R30,LOW(1)
	ST   Y,R30
	LDI  R30,LOW(0)
...
_0xD:
	...
	SBIW R26,8
	BRSH _0xE
; 0000 0062 PORTD = scan & 0xff;
	LD   R30,Y
	OUT  0x12,R30
; 0000 0063 PORTC = image_code[(offset + i) % 35];
	RCALL SUBOPT_0x0
; 0000 0064 scan <<= 1;
...
; 0000 0066 }
	...
	RJMP _0xD
_0xE:
; 0000 0067 PORTD = 0; //C1-C8
	LDI  R30,LOW(0)
	OUT  0x12,R30
; 0000 0068 for (i = 8; i < 16; i++) {
	LDI  R30,LOW(8)
	LDI  R31,HIGH(8)
	STD  Y+8,R30
	STD  Y+8+1,R31
_0x10:
	...
	SBIW R26,16
	BRSH _0x11
; 0000 0069 PORTA = scan >> 8;
	__GETD2S 0
	LDI  R30,LOW(8)
	RCALL __LSRD12
	OUT  0x1B,R30
; 0000 006A PORTC = image_code[(offset + i) % 35];
	RCALL SUBOPT_0x0
; 0000 006B scan <<= 1;
; 0000 006C delay_ms(2);
; 0000 006D }
	RCALL SUBOPT_0x1
	RJMP _0x10
_0x11:
