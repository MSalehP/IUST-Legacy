...
_image_code:
	.DB  0x1,0x6D,0x6D,0x6D,0x7D,0xFF,0x0,0xF7
	.DB  0xF7,0xF,0xFF,0x67,0x57,0x37,0xFF,0xBF
	.DB  0x57,0x57,0xF,0xFF,0x7,0xF7,0xF7,0xF
...
SUBOPT_0x0:
	...
	LDI  R31,HIGH(35)
	CALL __MODW21U
	SUBI R30,LOW(-_image_code*2)
	SBCI R31,HIGH(-_image_code*2)
	LPM  R0,Z
	OUT  0x15,R0
	CALL __GETD1S0
	CALL __LSLD1
