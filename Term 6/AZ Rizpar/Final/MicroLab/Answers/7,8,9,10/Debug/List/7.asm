...
_0x3:
	.DB  0x65,0x68,0x73,0x61,0x6E,0x20,0x61,0x68
	.DB  0x6D,0x61,0x64,0x70,0x6F,0x6F,0x72
_0x4:
	.DB  0x65,0x68,0x73,0x61,0x6E
_0x5:
	.DB  0x61,0x68,0x6D,0x61,0x64,0x70,0x6F,0x6F
	.DB  0x72
_0x2000003:
	.DB  0x80,0xC0
...
; 0000 00A2         lcd_puts(first_name);
	LDI  R26,LOW(_first_name)
	LDI  R27,HIGH(_first_name)
	RCALL _lcd_puts
...
; 0000 00A4         lcd_puts(last_name);
	LDI  R26,LOW(_last_name)
	LDI  R27,HIGH(_last_name)
	RCALL _lcd_puts
; 0000 00A5       }
; 0000 00A6 
