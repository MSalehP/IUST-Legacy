...
class ExampleDSLListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by ExampleDSLParser#hint.
    def enterHint(self, ctx:ExampleDSLParser.HintContext):
        pass

    # Exit a parse tree produced by ExampleDSLParser#hint.
    def exitHint(self, ctx:ExampleDSLParser.HintContext):
        pass


    # Enter a parse tree produced by ExampleDSLParser#boolean.
    def enterBoolean(self, ctx:ExampleDSLParser.BooleanContext):
        pass

    # Exit a parse tree produced by ExampleDSLParser#boolean.
    def exitBoolean(self, ctx:ExampleDSLParser.BooleanContext):
        pass
